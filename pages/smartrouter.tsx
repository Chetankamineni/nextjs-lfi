...
const Smartrouter = () => {
  return (
    <section className="min-h-screen flex items-center justify-center bg-white-100 p-4">
      <div className="relative bg-[#0099FF] text-white rounded-lg  w-full max-w-6xl px-8 pt-16 pb-32 overflow-hidden">
        

        <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-8">


          <div className="md:w-1/2 flex items-center z-10">
          ...
          <div className="md:w-1/2 flex items-center justify-center">
            <img
              src="/telkomsmart.png"
              alt="Happy Customer"
              className="h-auto w-auto object-contain transform scale-[2.2] -translate-x-1/4 origin-center opacity-90"
            />
          </div>
        </div>


        <div className="absolute bottom-6 left-6 right-6 z-20 bg-white text-black rounded-lg shadow-xl border border-gray-200 p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
            ...
            <div className="flex flex-col gap-4 pr-0 md:pr-12 pb-8 md:pb-0">
              ...
              <p className="text-sm text-[#005288] leading-relaxed max-w-[280px]">
